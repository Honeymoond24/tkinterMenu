...
class DailyMenu(tk.Frame):  # Класс.
    def __init__(self, parent, controller, database):  # Конструктор ежедневного меню.
        ...
        self.cards = Card(self.center, self.controller, self.database, "Суп", 1)
        self.cards1 = Card(self.center, self.controller, self.database, "Яичный ролл", 4)
        self.cards2 = Card(self.center, self.controller, self.database, "Картофель", 3)
        ...
        self.cards3 = Card(self.center, self.controller, self.database, "Суп", 1)
        self.cards4 = Card(self.center, self.controller, self.database, "Яичный ролл", 4)
        self.cards5 = Card(self.center, self.controller, self.database, "Картофель", 3)
        self.cards3.grid(row=1, column=2)
        self.cards4.grid(row=2, column=2)
        self.cards5.grid(row=3, column=2)

        self.cards6 = Card(self.center, self.controller, self.database, "Суп", 1)
        self.cards7 = Card(self.center, self.controller, self.database, "Яичный ролл", 4)
        self.cards8 = Card(self.center, self.controller, self.database, "Картофель", 3)
        ...
        self.cards9 = Card(self.center, self.controller, self.database, "Суп", 1)
        self.cards10 = Card(self.center, self.controller, self.database, "Яичный ролл", 4)
        self.cards11 = Card(self.center, self.controller, self.database, "Картофель", 3)
